...
-- =====================================================================
-- Hermosa Connect expansion: congestion + hotspot data model
-- NOTE: thresholds/algorithm are PROPOSED/CONFIGURABLE (see core/congestion.py).
-- A single stopped vehicle is NOT congestion; these tables model persistent,
-- aggregated, time-windowed traffic conditions.
-- =====================================================================

-- One row per congestion observation window per camera/location.
-- Ingested from a pluggable observation source (real detections or demo generator).
...
-- Derived congestion events (persistent condition over a time window).
...
-- Identified traffic hotspots (spatial aggregation of recurrent congestion).
